...
export default function PetDetailPage() {
  ...
  const flyerAccent = flyerIsLost ? tokens.colors.primary : tokens.map.flyerFound;
  const flyerAccentSoft = flyerIsLost ? tokens.map.flyerLostSoft : tokens.map.flyerFoundSoft;
  const flyerAccentBorder = flyerIsLost ? tokens.map.flyerLostBorder : tokens.map.flyerFoundBorder;
  ...
  const flyerCommonStyles = `
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @media print {
      body { background: ${c.bgBase} !important; padding: 0; }
    ...
    .photo-frame {
      ...
      background: linear-gradient(180deg, ${c.bgBase} 0%, ${c.bgSubtle} 100%);
      border: 1px solid var(--line);
      border-radius: 12px;
      overflow: hidden;
      display: flex;
  ...
  return (
    ...
    <div className="min-h-screen bg-background pt-8 pb-24 md:py-8">
      ...
      {showFlyerModal && (
        ...
        >
          <div
            className="bg-white dark:bg-background rounded-2xl p-8 shadow-2xl max-w-2xl w-full mx-auto"
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <button
                ...
                className="group relative bg-gradient-to-br from-primary/10 to-white dark:from-orange-950/30 dark:to-background border-2 border-primary rounded-2xl p-6 hover:shadow-xl transition-all duration-150 ease-in-out hover:scale-105 focus-within:ring-[3px] focus-within:ring-ring/50"
              >
              ...
              <button
                ...
                className="group relative bg-white dark:bg-card border-2 border-border rounded-2xl p-6 hover:border-primary hover:shadow-xl transition-all duration-300 hover:scale-105"
              >
                <div className="flex flex-col items-center text-center">
                  <div className="w-20 h-20 bg-muted group-hover:bg-primary-surface dark:group-hover:bg-orange-950/30 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-all">
      ...
      {instagramGuide && (
        ...
        >
          <div
            className="bg-white dark:bg-card rounded-2xl shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto border border-border"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="p-6">
