...
import { shelterPetsApi, settingsApi, sheltersApi, type ShelterPetInput, type ShelterResponse } from '@/shared/api/client';
              ...
              <div className="sm:col-span-2">
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  {form.photos.length < maxPhotos && form.photos.length > 0 && (
                    <label className="flex aspect-square cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-border transition-colors hover:border-primary hover:bg-muted/50 dark:border-border">
                ...
                {form.photos.length === 0 && (
                  <label
                    className={`flex h-64 w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-border transition-colors hover:border-primary hover:bg-muted/50 dark:border-border`}
                  >
