...
/**
 * —инхронизирует canonical, robots и базовые title/description по маршруту.
 * —траницы с данными (/pet/:id, /blog/:slug, Е) дополн€ют мету через applySeo.
 */
export function SeoRouteSync() {
  ...
  useEffect(() => {
    ...
    applySeo({
      title: 'DorogaDomoy.by Ч экосистема помощи животным',
      description: SEO_HOME_DESCRIPTION,
      canonicalUrl: canonical,
      robots,
      keywords: SEO_KEYWORDS,
