...
import { HOME_MODE_STORAGE_KEY } from '@/shared/lib/home-route';
import { matchOrangeFabActiveClass, matchOrangeFabClass } from '@/shared/styles/match-styles';
...
export function MobileBottomNav() {
  ...
  const centerFab = isSheltersMode ? (
    ...
    <button
      ...
      className={cn(FAB_CLASS, 'bg-primary text-primary-foreground shadow-primary/30')}
