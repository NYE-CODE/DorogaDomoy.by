            ...
            <>
              ...
              {user?.role === 'admin' && (
                <button type="button" onClick={() => go('/admin')} className={linkCls('/admin')}>
                  ...
                  <span className="text-primary font-medium">{t.header.adminPanel}</span>
                </button>
              )}
            </>
          )}
        ...
        <div className="border-t border-border px-5 py-3 shrink-0">
          {isAuthenticated ? (
            <button
              ...
              className="flex items-center gap-3 w-full px-0 py-3 text-destructive text-base font-medium"
            >
              <LogOut size={20} />
            ...
            <button
              type="button"
              onClick={handleLogin}
              className="flex items-center gap-3 w-full px-0 py-3 text-primary text-base font-medium"
            >
              <LogIn size={20} />
