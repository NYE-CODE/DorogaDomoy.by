...
export const adm = {
  ...
  filtersCard: 'bg-card border border-border rounded-md p-4 shadow-sm',
  settingsCard: 'bg-card border border-border rounded-md p-6 shadow-sm',
  settingsCardTitle: 'text-base font-semibold text-foreground mb-4',
  tableShell: 'rounded-md border border-border bg-card shadow-sm overflow-hidden',
  ...
  emptyBox:
    'rounded-md border border-border bg-card p-12 text-center text-sm text-muted-foreground shadow-sm',
  listCard: 'rounded-md border border-border bg-card p-4 sm:p-6 shadow-sm',
  ghostBtn:
  ...
  warnBanner:
    'text-sm text-amber-900 dark:text-amber-100 bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800 rounded-md px-4 py-3 max-w-3xl',
} as const;
