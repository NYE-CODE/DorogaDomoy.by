                    ...
                    <div className="absolute right-0 z-[100] mt-2 w-64 rounded-xl border border-border bg-card py-2 shadow-lg">
                      ...
                      <div className="py-2">
                        ...
                        <div className="mt-3 border-t border-border pt-2">
                          <button type="button" onClick={() => { setIsProfileOpen(false); void logout(); }} className="flex w-full items-center gap-3 px-4 py-2.5 text-left transition-colors hover:bg-destructive/10">
