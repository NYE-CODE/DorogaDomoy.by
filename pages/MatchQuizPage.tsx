...
import type { AdopterProfile } from '../types/adopter-profile';
import type { TraitLevel } from '../types/pet';
import { saveAdopterProfile, readAdopterProfile } from '../utils/adopter-profile-storage';
import { applySeo, canonicalUrlFromPath, SEO_ROBOTS_PRIVATE } from '../utils/seo';
import { appPrimaryCtaClass } from '../styles/cta-classes';
import { matchChoiceActiveClass, matchProgressBarClass } from '../styles/match-styles';
